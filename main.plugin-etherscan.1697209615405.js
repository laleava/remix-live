...
var _slicedToArray2 = _interopRequireDefault(__webpack_require__(87794));
var _react = _interopRequireWildcard(__webpack_require__(47182));
var _web = _interopRequireDefault(__webpack_require__(73450));
var _helper = __webpack_require__(63878);
var _formik = __webpack_require__(84458);
var _components = __webpack_require__(59138);
...
var getPathIcon = function getPathIcon(path) {
  return path.endsWith('.txt') ? 'far fa-file-alt' : path.endsWith('.md') ? 'fab fa-markdown' : path.endsWith('.sol') ? 'fak fa-solidity-mono' : path.endsWith('.js') ? 'fab fa-js' : path.endsWith('.json') ? 'small fas fa-brackets-curly' : path.endsWith('.vy') ? 'small fak fa-vyper2' : path.endsWith('.lex') ? 'fak fa-lexon' : path.endsWith('ts') ? 'small fak fa-ts-logo' : path.endsWith('.tsc') ? 'fad fa-brackets-curly' : path.endsWith('.cairo') ? 'small fak fa-cairo' : path.endsWith('.circom') ? 'fak fa-circom-plug1' : 'far fa-file';
};
...
//# sourceMappingURL=main.plugin-etherscan.1697209615405.js.map